...
This simulation implements the three-phase model from the paper:
...
**Key finding:** Slipping *must* be included to match experimental angular velocities (Fig. 7 of paper). The simple no-slip theory significantly underestimates ω.
